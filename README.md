Rustodon is a port of portions of the [Mastodon](https://joinmastodon.org) backend to Rust. It aims to reduce the resource requirements for running a Mastodon server.
